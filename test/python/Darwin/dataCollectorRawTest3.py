...
dc = '{"Layout":{"RootIdx":0,"RootLayoutType":"VLayout","HLayout":[{"Idx":0,"Elements":[{"Type":"Text","Idx":0},{"Type":"Image","Idx":0},{"Type":"Button","Idx":0}]},{"Idx":1,"Elements":[{"Type":"Text","Idx":1},{"Type":"Image","Idx":1},{"Type":"Checkbox","Idx":0}]}],"VLayout":[{"Idx":0,"Elements":[{"Type":"HLayout","Idx":0},{"Type":"HLayout","Idx":1}]}]},"Images":[{"Title":"texture","Uuid":"730ad959-4bf9-4252-be59-612ad944050f","Updating":true},{"Title":"thumbnail","Uuid":"874cea83-d897-4280-b066-b7eeba010fc1","Updating":false}],"Text":[{"Title":"s Hdr0","Body":"Rusty Texture"},{"Title":"s Hdr1","Body":"UFO Screenshot"}],"Button":[{"Title":"The Button","Action":"Perform task"}],"Checkbox":[{"Title":"Validate Test","value":true}],"lineGraph":[{"title":"asset upconvert tests success","avg":2,"max":5,"min":0,"samples":[0,1,3,2,3,2,1,4,4,4]}]}'
